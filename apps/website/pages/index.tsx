        ...
        <section className="bg-gradient-to-r from-galatasaray-dark to-galatasaray-red py-20">
          <div className="container-custom text-center text-white">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button variant="primary" size="lg">Projeleri Keşfet</Button>
              <Button variant="secondary" size="lg">Daha Fazla Bilgi</Button>
            </div>
          </div>
        </section>
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {projects.map((project, idx) => (
                <Card key={idx} className="border-l-4 border-galatasaray-yellow">
        ...
        <section className="bg-galatasaray-dark text-white py-16">
          <div className="container-custom text-center">
            ...
            <Button 
              variant="primary" 
              size="lg"
              className="bg-galatasaray-yellow text-galatasaray-dark hover:bg-galatasaray-red hover:text-white"
            >
              Bize Ulaşın
            </Button>
          </div>
